...
- [x] **_[iter](src/iter)_** 
  ...
  - [ ] **_[SliceIter](src/iter)_**  `Next | HasNext | Count | Size | FromSlice | ToSlice | Fold | FoldLeft | Map | Reduce | Filter | Foreach | Slice | Take | TakeWhile | Drop | DropWhile | Contains |Clone`
